...
import static com.zuel.backend.constant.UserConstant.ADMIN_ROLE;
import static com.zuel.backend.constant.UserConstant.USER_LOGIN_STATE;
/**
* @author jojo
* @description 针对表【user(用户)】的数据库操作Service实现
* @createDate 2024-02-29 14:55:59
*/
@Service
public class UserServiceImpl extends ServiceImpl<UserMapper, User>
     ...
     * 盐值，混淆密码
     */
    public static final String SALT = "JosephJostar";
